...
router.patch('/re-examination/:id/edit', NursingController.editReExam);
router.patch('/re-examination/:id/done', NursingController.updateReExamDone);
router.put('/re-examination/:id/update', validateUpload.reExaminationUploadImg, NursingController.uploadReExam);
...
router.post('/customer-information/:id/operating-counselor', validateUpload.counselorUploadImg, NursingController.uploadCounselor);
router.post('/customer-information/:id/operating-before', validateUpload.beforeUploadImg, NursingController.uploadBefore);
router.post('/customer-information/:id/operating-in-surgery', validateUpload.inSurgeryUploadImg, NursingController.uploadInSurgery);
router.post('/customer-information/:id/operating-after', validateUpload.afterUploadImg, NursingController.uploadAfter);
...
router.patch('/schedule/:id/edit', NursingController.editSchedule);
