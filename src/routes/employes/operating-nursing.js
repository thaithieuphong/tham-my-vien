...
// router.get('/storage-schedule', NursingController.showStorageSchedule);
...
router.post('/storage-cus-info/:id/create-re-examination', NursingController.createReExam);
router.get('/storage-cus-info', NursingController.showStorageCusInfo);
router.put('/service-note/:id/done', NursingController.updateServiceNoteDone);
