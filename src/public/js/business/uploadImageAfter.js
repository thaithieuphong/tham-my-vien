...
const previewAfterImg = document.querySelector('#preview-images-after');

const inputAfterImage = document.querySelector('#input-multi-images-after');
const dataImgAfterID = inputAfterImage.getAttribute('data-after-id');
const dataImgAfterCusID = inputAfterImage.getAttribute('data-after-customer-id');

// Create a FilePond instance
const uploadAfterImg = FilePond.create(previewAfterImg, {
    name: 'after',
...
uploadAfterImg.setOptions({
    fileMetadataObject: {
        cusID: dataImgAfterCusID
    },
    server: {
        process: (fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
            ...
            request.open('POST', `/business/employ/service-note/${dataImgAfterID}/uploadAfterImages`);
