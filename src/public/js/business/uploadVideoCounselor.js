...
const previewCounselorVideo = document.querySelector('#preview-videos-counselor');

const inputCounselorData = document.querySelector('#input-multi-videos-counselor');
const dataCounselorID = inputCounselorData.getAttribute('data-counselor-id');
const dataCounselorCusID = inputCounselorData.getAttribute('data-counselor-customer-id');

// Create a FilePond instance

const uploadCounselorVideo = FilePond.create(previewCounselorVideo, {
    name: 'counselor',
...
uploadCounselorVideo.setOptions({
    fileMetadataObject: {
        cusID: dataCounselorCusID,
    },
    server: {
        process: (fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
            ...
            request.open('POST', `/business/employ/service-note/${dataCounselorID}/uploadCounselorVideos`);
