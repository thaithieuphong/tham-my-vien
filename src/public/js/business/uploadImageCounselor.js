...
const previewCounselorImg = document.querySelector('#preview-images-counselor');

const inputCounselorImage = document.querySelector('#input-multi-images-counselor');
const dataImgCounselorID = inputCounselorImage.getAttribute('data-counselor-id');
const dataImgCounselorCusID = inputCounselorImage.getAttribute('data-counselor-customer-id');

// Create a FilePond instance
const uploadCounselorImg = FilePond.create(previewCounselorImg, {
    name: 'counselor',
...
uploadCounselorImg.setOptions({
    ...
    server: {
        process: (fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
            ...
            request.open('POST', `/business/employ/service-note/${dataImgCounselorID}/uploadCounselorImages`);
