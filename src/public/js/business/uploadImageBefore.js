...
const previewBeforeImg = document.querySelector('#preview-images-before');

const inputBeforeImage = document.querySelector('#input-multi-images-before');
const dataImgBeforeID = inputBeforeImage.getAttribute('data-before-id');
const dataImgBeforeCusID = inputBeforeImage.getAttribute('data-before-customer-id');

// Create a FilePond instance
const uploadBeforeImg = FilePond.create(previewBeforeImg, {
    name: 'before',
...
uploadBeforeImg.setOptions({
    fileMetadataObject: {
        cusID: dataImgBeforeCusID
    },
    server: {
        process: (fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
            ...
            request.open('POST', `/business/employ/service-note/${dataImgBeforeID}/uploadBeforeImages`);
