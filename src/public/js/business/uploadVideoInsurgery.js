...
const previewInSurgeryVideo = document.querySelector('#preview-videos-in-surgery');

const inputInSurgeryData = document.querySelector('#input-multi-videos-in-surgery');
const dataInsurgeryID = inputInSurgeryData.getAttribute('data-in-surgery-id');
const dataInsurgeryCusID = inputInSurgeryData.getAttribute('data-in-surgery-customer-id');

// Create a FilePond instance

const uploadInSurgeryVideo = FilePond.create(previewInSurgeryVideo, {
    name: 'inSurgery',
...
uploadInSurgeryVideo.setOptions({
    fileMetadataObject: {
        cusID: dataInsurgeryCusID,
    },
    server: {
        process: (fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
            ...
            request.open('POST', `/business/employ/service-note/${dataInsurgeryID}/uploadInSurgeryVideos`);
