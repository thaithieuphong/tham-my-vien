...
const inputElementVideo = document.querySelector('#preview-videos-re-exam');

const inputData = document.querySelector('#input-multi-videos-re-exam');
const dataReExamID = inputData.getAttribute('data-re-exam-id');
const dataCusID = inputData.getAttribute('data-cus-id');
...
uploadVideo.setOptions({
    ...
    server: {
        process: (fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
            ...
            request.open('POST', `/customer-care/employ/re-exam/${dataReExamID}/uploadVideos`);
