...
const inputElementImg = document.querySelector('#preview-images-re-exam');

const inputImage = document.querySelector('#input-multi-images-re-exam');
const dataImgReExamID = inputImage.getAttribute('data-re-exam-id');
const dataImgCusID = inputImage.getAttribute('data-cus-id');
...
uploadImg.setOptions({
    ...
    server: {
        process: (fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
            ...
            request.open('POST', `/customer-care/employ/re-exam/${dataImgReExamID}/uploadImages`);
