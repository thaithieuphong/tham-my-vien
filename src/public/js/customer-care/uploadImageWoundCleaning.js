...
const inputElementImg = document.querySelector('#preview-images-wound-cleaning');

const inputImage = document.querySelector('#input-multi-images-wound-cleaning');
const dataImgWoundCleaningID = inputImage.getAttribute('data-wound-cleaning-id');
const dataImgWoundCleaningCusID = inputImage.getAttribute('data-wound-cleaning-customer-id');

// Create a FilePond instance
const uploadImg = FilePond.create(inputElementImg, {
    name: 'woundCleaning',
...
uploadImg.setOptions({
    fileMetadataObject: {
        cusID: dataImgWoundCleaningCusID
    },
    server: {
        process: (fieldName, file, metadata, load, error, progress, abort, transfer, options) => {
            ...
            request.open('POST', `/customer-care/employ/wound-cleaning/${dataImgWoundCleaningID}/uploadImages`);
